...
import StarSVGComponent from "@/components/starButton/starSVGComponent";
...
export default function StarButton({ initialState, user_id, post_id, className, ...props }: Props & { className?: string }) {
