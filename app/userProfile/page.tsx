  ...
  return (
    <div>
      ...
      <div className="justify-center flex text-center gap-8">
        ...
        <div className="w-[148px] h-[148px] text-xs pt-5 bg-notWhite rounded-md border-2 border-darkGreen ">
          Renewable energies
        </div>
      </div>
      <div className="border-2 border-darkGreen mt-8 rounded-md text-center w-[333px] h-[160px] overflow-scroll">
        <div className=" font-poppins">
          We are a family of five with one dog. We are learning to renew the
          energy and trying to use the renewable energy as much as we can.
        </div>
      </div>
      <News />
    </div>
